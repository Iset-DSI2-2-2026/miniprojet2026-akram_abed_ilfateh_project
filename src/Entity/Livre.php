...
#[ApiResource(
    operations: [
        new Get(normalizationContext: ['groups' => ['livre:read']]),
        new GetCollection(normalizationContext: ['groups' => ['livre:read']]),
        new Post(normalizationContext: ['groups' => ['livre:read']], denormalizationContext: ['groups' => ['livre:write']]),
        new Put(normalizationContext: ['groups' => ['livre:read']], denormalizationContext: ['groups' => ['livre:write']]),
        new Delete(),
    ],
